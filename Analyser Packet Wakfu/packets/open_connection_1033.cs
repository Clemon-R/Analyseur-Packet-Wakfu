...
{
    public class open_connection_1033 : default_packet
    {
        private byte[] data;
        public open_connection_1033(default_packet pck) : base(pck.Len,pck.ID, pck.linker,pck.type)
        {
            this.know = true;
        }
        ...
        {
            list.Items.Add("Ouverture de connexion");
        }
